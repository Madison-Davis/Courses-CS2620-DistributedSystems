...
from comm import chat_pb2 as chat__pb2
...
class ChatServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPassword = channel.unary_unary(
                '/chat.ChatService/GetPassword',
                request_serializer=chat__pb2.GetPasswordRequest.SerializeToString,
                response_deserializer=chat__pb2.GetPasswordResponse.FromString,
                _registered_method=True)
        ...
        self.SendMessage = channel.unary_unary(
                ...
                _registered_method=True)
        self.AddDraft = channel.unary_unary(
                '/chat.ChatService/AddDraft',
                request_serializer=chat__pb2.AddDraftRequest.SerializeToString,
                response_deserializer=chat__pb2.AddDraftResponse.FromString,
                _registered_method=True)
        self.SaveDrafts = channel.unary_unary(
                '/chat.ChatService/SaveDrafts',
                request_serializer=chat__pb2.SaveDraftsRequest.SerializeToString,
                response_deserializer=chat__pb2.GenericResponse.FromString,
                _registered_method=True)
        self.CheckMessage = channel.unary_unary(
                '/chat.ChatService/CheckMessage',
                request_serializer=chat__pb2.CheckMessageRequest.SerializeToString,
                response_deserializer=chat__pb2.GenericResponse.FromString,
                _registered_method=True)
        self.DownloadMessage = channel.unary_unary(
                '/chat.ChatService/DownloadMessage',
                request_serializer=chat__pb2.DownloadMessageRequest.SerializeToString,
                response_deserializer=chat__pb2.GenericResponse.FromString,
                _registered_method=True)
...
def add_ChatServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetPassword': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=chat__pb2.GetPasswordRequest.FromString,
                    response_serializer=chat__pb2.GetPasswordResponse.SerializeToString,
            ),
            ...
            'AddDraft': grpc.unary_unary_rpc_method_handler(
                    servicer.AddDraft,
                    request_deserializer=chat__pb2.AddDraftRequest.FromString,
                    response_serializer=chat__pb2.AddDraftResponse.SerializeToString,
            ),
            'SaveDrafts': grpc.unary_unary_rpc_method_handler(
                    servicer.SaveDrafts,
                    request_deserializer=chat__pb2.SaveDraftsRequest.FromString,
                    response_serializer=chat__pb2.GenericResponse.SerializeToString,
            ),
            'CheckMessage': grpc.unary_unary_rpc_method_handler(
                    servicer.CheckMessage,
                    request_deserializer=chat__pb2.CheckMessageRequest.FromString,
                    response_serializer=chat__pb2.GenericResponse.SerializeToString,
            ),
            'DownloadMessage': grpc.unary_unary_rpc_method_handler(
                    servicer.DownloadMessage,
                    request_deserializer=chat__pb2.DownloadMessageRequest.FromString,
                    response_serializer=chat__pb2.GenericResponse.SerializeToString,
            ),
...
class ChatService(object):
    ...
    def GetPassword(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/chat.ChatService/GetPassword',
            chat__pb2.GetPasswordRequest.SerializeToString,
            chat__pb2.GetPasswordResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def AddDraft(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/chat.ChatService/AddDraft',
            chat__pb2.AddDraftRequest.SerializeToString,
            chat__pb2.AddDraftResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SaveDrafts(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/chat.ChatService/SaveDrafts',
            chat__pb2.SaveDraftsRequest.SerializeToString,
            chat__pb2.GenericResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def CheckMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/chat.ChatService/CheckMessage',
            chat__pb2.CheckMessageRequest.SerializeToString,
            chat__pb2.GenericResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def DownloadMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/chat.ChatService/DownloadMessage',
            chat__pb2.DownloadMessageRequest.SerializeToString,
            chat__pb2.GenericResponse.FromString,
            options,
            channel_credentials,
            insecure,
