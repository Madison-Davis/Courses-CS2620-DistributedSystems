...
class TestChatClient(unittest.TestCase):
    ...
    def test_login_success(self):
        ...
        # Receive and compare response to expectation
    ...
    def test_send_message_success(self):
        # Simulate a successful message sending interaction (not live)
    ...
    def test_download_message_success(self):
        # Prepare a request to download message from inbox
    ...
    def test_check_message_success(self):
        # Prepare a request to check message as read
    ...
    def test_delete_message_success(self):
        # Simulate a user deleting a message
    ...
    def test_add_draft_success(self):
        # Simulate a new draft to be added to the database
    ...
    def test_save_drafts_success(self):
        # Simulate a user saving their draft status (message, recipient, etc.)
    ...
    def test_logout_success(self):
        # Simulate a user logging out of the current session
    ...
    def test_list_accounts_success(self):
        # Prepare a call to list all existing accounts
    ...
    def test_delete_account_success(self):
        # Simulate a user deleting their account
        response = chat_pb2.GenericResponse(success=True, message="Deleted")
    ...
    def test_get_password_success(self):
        # Prepare a call to retrieve password hash
