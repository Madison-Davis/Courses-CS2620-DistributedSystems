...
2. For all functions in tests_rpc.py, server.py and chat_client.py, and gui.py, we put comments under each function header to help readers understand its implementation.
